...
import { selecGroceryByType, selectGroceries } from '../../store/selectors/grocery.selectors';
...
export class GroceryComponent {
  ...
  onTypeChange(event: Event){
    ...
    if(selectedType) this.filteredGroceries$ = this.store.select(selecGroceryByType(selectedType))
